  ...
  bg-cover bg-center text-black">
        ...
        <div className="min-h-screen grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 ">
          {products.map((product) => (
            ...
            >
              <CardBody className="bg-gray-50 rounded-sm relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] p-6">
                <CardItem
                  translateZ="50"
